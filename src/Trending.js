...
const Trending = ({ darkMode }) => {
  ...
  <div className="flex gap-6 transition-transform duration-500 ease-in-out transform  ">
      ...
      >
        ...
        <div className="mt-4 flex justify-between">
          ...
          <button
            ...
            disabled={currentSlideOne + itemsPerPage >= TrendingArray.length}
          >
            <IconChevronsRight />
          </button>
        </div>
